...
## `apply.py` — install the extension

`skills/soliplex-concierge-installer/scripts/apply.py` wires the extension into
a `soliplex-template`-generated stack, idempotently. See
