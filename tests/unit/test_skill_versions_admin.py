...
def test_skill_versions_constants():
    ...
    assert module.ASSET_TARBALL == "soliplex-concierge-admin-skill.tar.gz"
    assert module.POINTER_TAG == "admin-skill-latest"
    assert module._ROLLING_RE.match("admin-skill-2026.06.05-abc1234")
